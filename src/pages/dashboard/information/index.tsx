...
import { TICKET_CANCELLATION_SAMPLES,TICKET_CANCELLATION_COLUMNS} from "./ticket-cancellation";
...
const Information: React.FC = () => {
  ...
  return (
    <div className="mt-10">
      ...
      {segment === "ticket-cancellation" && (<div className="mt-[32px] mb-[48px] mx-[24px]">
          <ProTable
